...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-40 flex items-center bg-gradient-to-r from-black/80 via-black/40 to-transparent px-6 md:px-0 md:pl-24">
        <motion.div
